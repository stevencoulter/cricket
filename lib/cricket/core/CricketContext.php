...
class CricketContext {
    ...
    public function call_action($inActionID, $inData = null, $indicatorID = null, $confirmation = null, $requestChannel = null, $inMutable = true) {
        ...
        return "require('cricket').ajax('$url', $data, $iID, $conf, $channel);";
    ...
    public function action($inFormSelector, $inActionID, $inIndicatorID = null, $inConfirmation = null, $requestChannel = null) {
        $js = $this->call_form_action("document.querySelector('{$inFormSelector}')", $inActionID, $inIndicatorID, $inConfirmation, $requestChannel);
    ...
    private function call_form_action($inJSFormReference, $inActionID, $inIndicatorID = null, $inConfirmation = null, $requestChannel = null) {
        ...
        return "require('cricket').ajax_form($inJSFormReference, '{$url}', $inIndicatorID, $inConfirmation, $requestChannel);";
    }
     ...
     * @return void
     */
    public function tpl_include($inPath, $additionalParams = []) {
     ...
     *
     * @todo Currently "$inFormSelector" is interpretted as an "ID".   This is unfortunate.  It really should be a
     *       jQuery selector.
     *
     * @param string $inActionID
     * @param string $inFormSelector
    ...
    public function form_submit($inActionID, $inIndicatorID = null, $inConfirmation = null, $inFormID = null, $requestChannel = null, $failSilent = false) {
        $form = "this";
        if($inFormID) {
            $form = "document.querySelector('#{$inFormID}')";
        }
        ...
        return "require('cricket').ajax_form($form, '$url', $ind, $confirm, $channel, $failSilent);";
    }
    ...
    public function action_link($action, $label, $params = null, $genIndicatorID = null, $inConfirmation = null) {
        $this->control_group($genIndicatorID, false, [
            [
                'type'    => 'link',
                'action'  => $action,
                'param'   => $params,
    ...
    public function action_button($action, $label, $params = null, $genIndicatorID = null, $indicatorFirst = true, $confirmation = null) {
        $this->control_group($genIndicatorID, $indicatorFirst, [
            [
                'type'    => 'button',
                'action'  => $action,
                'param'   => $params,
    ...
    public function action_ok_cancel($okAction, $okLabel, $okForm = true, $okNotFormParams = null, $okConfirm = null, $cancelAction = 'close', $cancelLabel = "Cancel", $indicatorFirst = true) {
        $this->control_group("ind_ok_cancel", $indicatorFirst, [
            [
                'type'   => "button",
                'action' => $cancelAction,
                'label'  => $cancelLabel,
